...
def evaluate(args: argparse.Namespace) -> None:
    ...
    default_log_dir = Path(args.output_dir) if getattr(args, "output_dir", None) else None
    if default_log_dir is None and args.predictions_path:
        default_log_dir = Path(args.predictions_path).parent
    metrics_logger = make_metrics_logger(args, default_dir=default_log_dir)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    train_parser.add_argument(
        "--metrics-log-path",
        default=None,
        help="CSV path for train/validation metrics; defaults to <output-dir>/metrics_log.csv.",
    )
    ...
    ensemble_scores_parser.add_argument("--output-path", required=True)
